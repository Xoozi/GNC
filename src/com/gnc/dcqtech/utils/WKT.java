...
public class WKT {
    ...
    public static String GeometryToWKT(Geometry geometry){        
        ...
        }else if("Polyline".equalsIgnoreCase(type.name())){  
            MultiPath pg = (MultiPath)geometry;  
            //geoStr = type.name()+" ("+"";  
            //geoStr = "LINESTRING"+" ("+"";  
            geoStr = "LINESTRING"+" "+""; 
    ...
    public static Geometry WKTToGeometry(String wkt){  
        ...
        String headStr = wkt.substring(0, end);  
        ...
        }else if(headStr.equalsIgnoreCase("Polyline") || headStr.equalsIgnoreCase("Polygon")||headStr.equalsIgnoreCase("LINESTRING")){  
            if(headStr.equalsIgnoreCase("LINESTRING")){
